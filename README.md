...
Generate deterministic glitch-art SVGs from a phrase and mint seed.

## Why this exists

Solana transaction v1 raises the maximum transaction size from 1,232 to 4,096 bytes. Glitch Mint explores a focused consumer use of that space while making the wire budget visible.
